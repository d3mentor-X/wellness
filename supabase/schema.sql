...
-- ----------------------------------------------------------------------------
-- Table 7e: daily_health_logs
-- Daily Sleep, Screen Time, and Digital Wellbeing logs
-- ----------------------------------------------------------------------------
...
-- ============================================================================
-- 7e. Daily Health Tracking (Sleep & Screen Time) - Phase 11
-- ============================================================================
...
-- Trigger for updated_at (safely repeatable)
...
-- Immutability validation trigger for sensitive foreign keys
...
-- RLS on daily_health_logs (STRICTLY private to owner)
...
-- Storage Bucket for Health Screenshots (Private bucket)
...
-- RPC Function: Get Daily Health Summary with 7-Day Trends
